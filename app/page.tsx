            ...
            <ul className="space-y-4 py-4">
              ...
              <li>
                ...
                >
                  ...
                  <span className="text-muted-foreground">
                    Find referral codes for brands you love!
                  </span>
                </Link>
              </li>
              <li>
                ...
                >
                  ...
                  <span className="text-muted-foreground">
                    Find deals on products and brands you love!
                  </span>
                </Link>
              </li>
            </ul>
            ...
            <ul className="space-y-4 py-4">
              ...
              <li>
                ...
                >
                  ...
                  <span className="text-muted-foreground">
                    mechanical engineer + engineering program manager
                  </span>
                </Link>
              </li>
              <li>
